...
from ULIIC.network.monitors import AbstractMonitor
from ULIIC.network.neurons import AbstractInput, Neurons
from ULIIC.network.synapese import AbstractConnection
from ULIIC.learning.reward import AbstractReward
...
class Network(torch.nn.Module):
    # language=rst
    """
    Most important object of the ``bindsnet`` package. Responsible for the simulation and interaction of Neurons and
    connections.
    ...
    **Example:**
    ...
    .. code-block:: python
        ...
        from bindsnet.network import Network, Neurons, topology, monitors

        network = Network(dt=1.0)  # Instantiates network.

        X = Neurons.Input(100)  # Input layer.
        Y = Neurons.LIFNeurons(100)  # Layer of LIF neurons.
    ...
    def add_layer(self, layer: Neurons, name: str) -> None:
        # language=rst
        """
        Adds a layer of Neurons to the network.

        :param layer: A subclass of the ``Neurons`` object.
    ...
    def add_connection(
        ...
        # language=rst
        """
        Adds a connection between layers of Neurons to the network.
    ...
    def run(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            from bindsnet.network.Neurons import Input
