...
File Information: This file includes abstract synapses class and some implemented synapses.
...
class AbstractConnection(ABC, Module):
    # language=rst
    """
    Abstract base method for connections between ``Neurons``.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param source: A layer of Neurons from which the connection originates.
        :param target: A layer of Neurons to which the connection connects.
        ...
        assert isinstance(source, Neurons), "Source is not a Neurons object"
        assert isinstance(target, Neurons), "Target is not a Neurons object"
        ...
        from ULIIC.learning.learning_rules import NoOp
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param ByteTensor norm_by_max_with_shadow_weights: Normalize the weight of a neuron by its max weight by
                                                           original weights.
        """
        super().__init__(source, target, nu, reduction, weight_decay, neederror, **kwargs)
...
class MaxPool2dConnection(AbstractConnection):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super().__init__(source, target, None, None, 0.0, neederror, **kwargs)
...
class MeanFieldConnection(AbstractConnection):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param float norm: Total weight per target neuron normalization constant.
        """
        super().__init__(source, target, nu, weight_decay, neederror, **kwargs)
